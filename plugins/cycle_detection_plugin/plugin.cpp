...
static auto const SELECTED_COLOR = Color{200, 50, 50};
static auto const UNSELECTED_COLOR = Color{200, 200, 200};
...
void onRootItemSelected(PluginTreeItemClickedActionHandler *handler)
{
    ...
    auto paintCycle = [&gv](auto&& cycle, auto&& color) {
    ...
    paintCycle(pluginData->prevSelectedCycle, UNSELECTED_COLOR);
    paintCycle(selectedCycle, SELECTED_COLOR);
