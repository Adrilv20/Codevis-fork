...
class JavaParserBaseListener : public JavaParserListener {
  public:
    ...
    virtual void enterCompactConstructorDeclaration(JavaParser::CompactConstructorDeclarationContext * /*ctx*/) override
    {
    }
    virtual void exitCompactConstructorDeclaration(JavaParser::CompactConstructorDeclarationContext * /*ctx*/) override
    {
    }
    ...
    virtual void
    enterGenericInterfaceMethodDeclaration(JavaParser::GenericInterfaceMethodDeclarationContext * /*ctx*/) override
    {
    }
    virtual void
    exitGenericInterfaceMethodDeclaration(JavaParser::GenericInterfaceMethodDeclarationContext * /*ctx*/) override
    {
    }

    virtual void
    enterInterfaceCommonBodyDeclaration(JavaParser::InterfaceCommonBodyDeclarationContext * /*ctx*/) override
    {
    }
    virtual void
    exitInterfaceCommonBodyDeclaration(JavaParser::InterfaceCommonBodyDeclarationContext * /*ctx*/) override
    {
    }
    ...
    virtual void
    enterAnnotationTypeElementDeclaration(JavaParser::AnnotationTypeElementDeclarationContext * /*ctx*/) override
    {
    }
    virtual void
    exitAnnotationTypeElementDeclaration(JavaParser::AnnotationTypeElementDeclarationContext * /*ctx*/) override
    {
    }
    ...
    virtual void
    enterAnnotationMethodOrConstantRest(JavaParser::AnnotationMethodOrConstantRestContext * /*ctx*/) override
    {
    }
    virtual void
    exitAnnotationMethodOrConstantRest(JavaParser::AnnotationMethodOrConstantRestContext * /*ctx*/) override
    {
    }
    ...
    virtual void
    enterNonWildcardTypeArgumentsOrDiamond(JavaParser::NonWildcardTypeArgumentsOrDiamondContext * /*ctx*/) override
    {
    }
    virtual void
    exitNonWildcardTypeArgumentsOrDiamond(JavaParser::NonWildcardTypeArgumentsOrDiamondContext * /*ctx*/) override
    {
    }
    ...
    virtual void
    enterExplicitGenericInvocationSuffix(JavaParser::ExplicitGenericInvocationSuffixContext * /*ctx*/) override
    {
    }
    virtual void
    exitExplicitGenericInvocationSuffix(JavaParser::ExplicitGenericInvocationSuffixContext * /*ctx*/) override
    {
    }
