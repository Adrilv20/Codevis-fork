...
class Java8Parser : public antlr4::Parser {
  public:
    ...
    enum {
        ...
        RuleNumericType = 2,
        RuleIntegralType = 3,
        RuleFloatingPointType = 4,
        RuleReferenceType = 5,
        RuleClassOrInterfaceType = 6,
        RuleClassType = 7,
        RuleClassType_lf_classOrInterfaceType = 8,
        RuleClassType_lfno_classOrInterfaceType = 9,
        RuleInterfaceType = 10,
        RuleInterfaceType_lf_classOrInterfaceType = 11,
        RuleInterfaceType_lfno_classOrInterfaceType = 12,
        RuleTypeVariable = 13,
        RuleArrayType = 14,
        RuleDims = 15,
        RuleTypeParameter = 16,
        RuleTypeParameterModifier = 17,
        RuleTypeBound = 18,
        RuleAdditionalBound = 19,
        RuleTypeArguments = 20,
        RuleTypeArgumentList = 21,
        RuleTypeArgument = 22,
        RuleWildcard = 23,
        RuleWildcardBounds = 24,
        RulePackageName = 25,
        RuleTypeName = 26,
        RulePackageOrTypeName = 27,
        RuleExpressionName = 28,
        RuleMethodName = 29,
        RuleAmbiguousName = 30,
        RuleCompilationUnit = 31,
        RulePackageDeclaration = 32,
        RulePackageModifier = 33,
        RuleImportDeclaration = 34,
        RuleSingleTypeImportDeclaration = 35,
        RuleTypeImportOnDemandDeclaration = 36,
        RuleSingleStaticImportDeclaration = 37,
        RuleStaticImportOnDemandDeclaration = 38,
        RuleTypeDeclaration = 39,
        RuleClassDeclaration = 40,
        RuleNormalClassDeclaration = 41,
        RuleClassModifier = 42,
        RuleTypeParameters = 43,
        RuleTypeParameterList = 44,
        RuleSuperclass = 45,
        RuleSuperinterfaces = 46,
        RuleInterfaceTypeList = 47,
        RuleClassBody = 48,
        RuleClassBodyDeclaration = 49,
        RuleClassMemberDeclaration = 50,
        RuleFieldDeclaration = 51,
        RuleFieldModifier = 52,
        RuleVariableDeclaratorList = 53,
        RuleVariableDeclarator = 54,
        RuleVariableDeclaratorId = 55,
        RuleVariableInitializer = 56,
        RuleUnannType = 57,
        RuleUnannPrimitiveType = 58,
        RuleUnannReferenceType = 59,
        RuleUnannClassOrInterfaceType = 60,
        RuleUnannClassType = 61,
        RuleUnannClassType_lf_unannClassOrInterfaceType = 62,
        RuleUnannClassType_lfno_unannClassOrInterfaceType = 63,
        RuleUnannInterfaceType = 64,
        RuleUnannInterfaceType_lf_unannClassOrInterfaceType = 65,
        RuleUnannInterfaceType_lfno_unannClassOrInterfaceType = 66,
        RuleUnannTypeVariable = 67,
        RuleUnannArrayType = 68,
        RuleMethodDeclaration = 69,
        RuleMethodModifier = 70,
        RuleMethodHeader = 71,
        RuleResult = 72,
        RuleMethodDeclarator = 73,
        RuleFormalParameterList = 74,
        RuleFormalParameters = 75,
        RuleFormalParameter = 76,
        RuleVariableModifier = 77,
        RuleLastFormalParameter = 78,
        RuleReceiverParameter = 79,
        RuleThrows_ = 80,
        RuleExceptionTypeList = 81,
        RuleExceptionType = 82,
        RuleMethodBody = 83,
        RuleInstanceInitializer = 84,
        RuleStaticInitializer = 85,
        RuleConstructorDeclaration = 86,
        RuleConstructorModifier = 87,
        RuleConstructorDeclarator = 88,
        RuleSimpleTypeName = 89,
        RuleConstructorBody = 90,
        RuleExplicitConstructorInvocation = 91,
        RuleEnumDeclaration = 92,
        RuleEnumBody = 93,
        RuleEnumConstantList = 94,
        RuleEnumConstant = 95,
        RuleEnumConstantModifier = 96,
        RuleEnumBodyDeclarations = 97,
        RuleInterfaceDeclaration = 98,
        RuleNormalInterfaceDeclaration = 99,
        RuleInterfaceModifier = 100,
        RuleExtendsInterfaces = 101,
        RuleInterfaceBody = 102,
        RuleInterfaceMemberDeclaration = 103,
        RuleConstantDeclaration = 104,
        RuleConstantModifier = 105,
        RuleInterfaceMethodDeclaration = 106,
        RuleInterfaceMethodModifier = 107,
        RuleAnnotationTypeDeclaration = 108,
        RuleAnnotationTypeBody = 109,
        RuleAnnotationTypeMemberDeclaration = 110,
        RuleAnnotationTypeElementDeclaration = 111,
        RuleAnnotationTypeElementModifier = 112,
        RuleDefaultValue = 113,
        RuleAnnotation = 114,
        RuleNormalAnnotation = 115,
        RuleElementValuePairList = 116,
        RuleElementValuePair = 117,
        RuleElementValue = 118,
        RuleElementValueArrayInitializer = 119,
        RuleElementValueList = 120,
        RuleMarkerAnnotation = 121,
        RuleSingleElementAnnotation = 122,
        RuleArrayInitializer = 123,
        RuleVariableInitializerList = 124,
        RuleBlock = 125,
        RuleBlockStatements = 126,
        RuleBlockStatement = 127,
        RuleLocalVariableDeclarationStatement = 128,
        RuleLocalVariableDeclaration = 129,
        RuleStatement = 130,
        RuleStatementNoShortIf = 131,
        RuleStatementWithoutTrailingSubstatement = 132,
        RuleEmptyStatement_ = 133,
        RuleLabeledStatement = 134,
        RuleLabeledStatementNoShortIf = 135,
        RuleExpressionStatement = 136,
        RuleStatementExpression = 137,
        RuleIfThenStatement = 138,
        RuleIfThenElseStatement = 139,
        RuleIfThenElseStatementNoShortIf = 140,
        RuleAssertStatement = 141,
        RuleSwitchStatement = 142,
        RuleSwitchBlock = 143,
        RuleSwitchBlockStatementGroup = 144,
        RuleSwitchLabels = 145,
        RuleSwitchLabel = 146,
        RuleEnumConstantName = 147,
        RuleWhileStatement = 148,
        RuleWhileStatementNoShortIf = 149,
        RuleDoStatement = 150,
        RuleForStatement = 151,
        RuleForStatementNoShortIf = 152,
        RuleBasicForStatement = 153,
        RuleBasicForStatementNoShortIf = 154,
        RuleForInit = 155,
        RuleForUpdate = 156,
        RuleStatementExpressionList = 157,
        RuleEnhancedForStatement = 158,
        RuleEnhancedForStatementNoShortIf = 159,
        RuleBreakStatement = 160,
        RuleContinueStatement = 161,
        RuleReturnStatement = 162,
        RuleThrowStatement = 163,
        RuleSynchronizedStatement = 164,
        RuleTryStatement = 165,
        RuleCatches = 166,
        RuleCatchClause = 167,
        RuleCatchFormalParameter = 168,
        RuleCatchType = 169,
        RuleFinally_ = 170,
        RuleTryWithResourcesStatement = 171,
        RuleResourceSpecification = 172,
        RuleResourceList = 173,
        RuleResource = 174,
        RulePrimary = 175,
        RulePrimaryNoNewArray = 176,
        RulePrimaryNoNewArray_lf_arrayAccess = 177,
        RulePrimaryNoNewArray_lfno_arrayAccess = 178,
        RulePrimaryNoNewArray_lf_primary = 179,
        RulePrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary = 180,
        RulePrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary = 181,
        RulePrimaryNoNewArray_lfno_primary = 182,
        RulePrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary = 183,
        RulePrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary = 184,
        RuleClassInstanceCreationExpression = 185,
        RuleClassInstanceCreationExpression_lf_primary = 186,
        RuleClassInstanceCreationExpression_lfno_primary = 187,
        RuleTypeArgumentsOrDiamond = 188,
        RuleFieldAccess = 189,
        RuleFieldAccess_lf_primary = 190,
        RuleFieldAccess_lfno_primary = 191,
        RuleArrayAccess = 192,
        RuleArrayAccess_lf_primary = 193,
        RuleArrayAccess_lfno_primary = 194,
        RuleMethodInvocation = 195,
        RuleMethodInvocation_lf_primary = 196,
        RuleMethodInvocation_lfno_primary = 197,
        RuleArgumentList = 198,
        RuleMethodReference = 199,
        RuleMethodReference_lf_primary = 200,
        RuleMethodReference_lfno_primary = 201,
        RuleArrayCreationExpression = 202,
        RuleDimExprs = 203,
        RuleDimExpr = 204,
        RuleConstantExpression = 205,
        RuleExpression = 206,
        RuleLambdaExpression = 207,
        RuleLambdaParameters = 208,
        RuleInferredFormalParameterList = 209,
        RuleLambdaBody = 210,
        RuleAssignmentExpression = 211,
        RuleAssignment = 212,
        RuleLeftHandSide = 213,
        RuleAssignmentOperator = 214,
        RuleConditionalExpression = 215,
        RuleConditionalOrExpression = 216,
        RuleConditionalAndExpression = 217,
        RuleInclusiveOrExpression = 218,
        RuleExclusiveOrExpression = 219,
        RuleAndExpression = 220,
        RuleEqualityExpression = 221,
        RuleRelationalExpression = 222,
        RuleShiftExpression = 223,
        RuleAdditiveExpression = 224,
        RuleMultiplicativeExpression = 225,
        RuleUnaryExpression = 226,
        RulePreIncrementExpression = 227,
        RulePreDecrementExpression = 228,
        RuleUnaryExpressionNotPlusMinus = 229,
        RulePostfixExpression = 230,
        RulePostIncrementExpression = 231,
        RulePostIncrementExpression_lf_postfixExpression = 232,
        RulePostDecrementExpression = 233,
        RulePostDecrementExpression_lf_postfixExpression = 234,
        RuleCastExpression = 235
    };

    explicit Java8Parser(antlr4::TokenStream *input);

    Java8Parser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions& options);

    ~Java8Parser() override;
    ...
    class UnannClassOrInterfaceTypeContext : public antlr4::ParserRuleContext {
      public:
        ...
        std::vector<UnannInterfaceType_lf_unannClassOrInterfaceTypeContext *>
        unannInterfaceType_lf_unannClassOrInterfaceType();
        UnannInterfaceType_lf_unannClassOrInterfaceTypeContext *
        unannInterfaceType_lf_unannClassOrInterfaceType(size_t i);
    ...
    class UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext : public antlr4::ParserRuleContext {
      public:
        UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext(antlr4::ParserRuleContext *parent,
    ...
    class PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext : public antlr4::ParserRuleContext {
      public:
        PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext(antlr4::ParserRuleContext *parent,
                                                                      size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    class PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext : public antlr4::ParserRuleContext {
      public:
        PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext(antlr4::ParserRuleContext *parent,
                                                                        size_t invokingState);
        virtual size_t getRuleIndex() const override;
        ClassInstanceCreationExpression_lf_primaryContext *classInstanceCreationExpression_lf_primary();
        FieldAccess_lf_primaryContext *fieldAccess_lf_primary();
    ...
    class PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext : public antlr4::ParserRuleContext {
      public:
        PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext(antlr4::ParserRuleContext *parent,
                                                                          size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    class PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext : public antlr4::ParserRuleContext {
      public:
        PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext(antlr4::ParserRuleContext *parent,
                                                                            size_t invokingState);
        virtual size_t getRuleIndex() const override;
        LiteralContext *literal();
        TypeNameContext *typeName();
    ...
    class ArrayAccess_lf_primaryContext : public antlr4::ParserRuleContext {
      public:
        ...
        std::vector<antlr4::tree::TerminalNode *> RBRACK();
        antlr4::tree::TerminalNode *RBRACK(size_t i);
        std::vector<PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext *>
        primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary();
        PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext *
        primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary(size_t i);
    ...
    class ArrayAccess_lfno_primaryContext : public antlr4::ParserRuleContext {
      public:
        ...
        PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext *
        primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary();
        std::vector<PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext *>
        primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary();
        PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext *
        primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary(size_t i);
    ...
    class PostfixExpressionContext : public antlr4::ParserRuleContext {
      public:
        ...
        PrimaryContext *primary();
        ExpressionNameContext *expressionName();
        std::vector<PostIncrementExpression_lf_postfixExpressionContext *>
        postIncrementExpression_lf_postfixExpression();
        PostIncrementExpression_lf_postfixExpressionContext *postIncrementExpression_lf_postfixExpression(size_t i);
        std::vector<PostDecrementExpression_lf_postfixExpressionContext *>
