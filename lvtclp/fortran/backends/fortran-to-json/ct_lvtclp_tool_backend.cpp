...
QJsonDocument runFortranToJsonAndGetOutputs()
{
    ...
    //    fortranToJsonTool.setWorkingDirectory("");
    fortranToJsonTool.start(FORTRAN_TO_JSON_EXECUTABLE, QStringList({"-v77l", "a.f"}));
...
void runFullOnCommand(CompileCommand const& cmd)
{
    ...
    auto jsonAST = runFortranToJsonAndGetOutputs();
