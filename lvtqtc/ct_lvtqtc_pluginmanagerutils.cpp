...
PluginTreeItemHandler
PluginManagerQtUtils::createPluginTreeItemHandler(PluginManager *pm, QTreeView *treeView, QStandardItemModel *treeModel, QStandardItem *item, GraphicsScene *gs)
{
    ...
    auto addOnClickAction = [pm, treeView, treeModel, item, gs](PluginTreeItemHandler::onClickItemAction_f const &f) {
        QObject::connect(treeView, &QTreeView::clicked, treeView, [pm, item, f, treeView, treeModel, gs](const QModelIndex &index) {
...
PluginTreeItemClickedActionHandler PluginManagerQtUtils::createPluginTreeItemClickedActionHandler(PluginManager *pm,
                                                                                                  QTreeView *treeView,
...
PluginGraphicsViewHandler PluginManagerQtUtils::createPluginGraphicsViewHandler(GraphicsScene *gs)
{
    ...
    auto getEdgeByQualifiedName = [gs](std::string const &fromQualifiedName, std::string const &toQualifiedName) -> std::optional<Edge> {
