...
void MainWindow::setupActions()
{
    ...
    actionCollection()->setDefaultShortcut(action, static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) | static_cast<int>(Qt::Key_T));
    ...
    actionCollection()->setDefaultShortcut(action, static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) | static_cast<int>(Qt::SHIFT) | static_cast<int>(Qt::Key_W));
